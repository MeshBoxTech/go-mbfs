...
import (
	...
	smux "mbfs/go-mbfs/gx/QmY9JXR3FupnYAYJWK9aMr9bCpqWKcToQ1tz8DVGTrHpHw/go-stream-muxer" // Conn is a connection to a remote peer.
	mp "mbfs/go-mbfs/gx/QmepcK13D1utrmryTQWaBPeipsVXW7sdStWfa6fWtYCoTE/go-mplex" // Conn is a connection to a remote peer.
)
