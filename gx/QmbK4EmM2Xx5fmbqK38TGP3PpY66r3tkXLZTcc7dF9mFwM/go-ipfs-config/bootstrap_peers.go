...
import (
	...
	iaddr "mbfs/go-mbfs/gx/QmUSE3APe1pMFVsUBZUZaKQKERiPteCWvTAERtVQmtXzgE/go-ipfs-addr"
	// Needs to be imported so that users can import this package directly
	// and still parse the bootstrap addresses.
	_ "mbfs/go-mbfs/gx/QmT4zgnKCyZBpRyxzsvZqUjzUkMWLJ2pZCw7uk6M6Kto5m/go-multiaddr-dns"
)
...
//
// NOTE: This is here -- and not inside cmd/mbfs/init.go -- because of an
...
// This is here (and not inside cmd/mbfs/init) because of module dependency problems.
