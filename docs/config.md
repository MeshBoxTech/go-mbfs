...
As of writing, [7 hash functions](https://mbfs/go-mbfs-blockstore/blob/547442836ade055cc114b562a3cc193d4e57c884/caching.go#L22) are used, so the constant `k` is 7 in the formula.
...
See [this issue](https://mbfs/go-mbfs/issues/1226#issuecomment-120494604) for more
information.
