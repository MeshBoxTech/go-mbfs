...
import (
	...
	"mbfs/go-mbfs/gx/QmXLCwhHh7bxRsBnCKNE9BAN87V44aSxXLquZYTtjr6fZ3/go-unixfs/importer"
	...
	multibase "mbfs/go-mbfs/gx/QmekxXDhCxCJRNuzmHreuaT3BsuJcsjcXWNrtV9C8DRHtd/go-multibase"
)
...
func (i *gatewayHandler) getOrHeadHandler(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// added by vingo
	dr, err := i.api.Unixfs().Get(ctx, resolvedPath,nil)
	/////////////
	...
	case err == nil:
		...
		// added by vingo
		dr, err := i.api.Unixfs().Get(ctx, coreiface.IpfsPath(ixnd.Cid()),nil)
		//////////
	...
	// https://mbfs/go-mbfs/issues/1365
