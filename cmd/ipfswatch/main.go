...
import (
	...
	fsnotify "mbfs/go-mbfs/gx/QmfNjggF4Pt6erqg3NDafD3MdvDHk1qqCVr8pL5hnPucS8/fsnotify"
)

var http = flag.Bool("http", false, "expose IPFS HTTP API")
var repoPath = flag.String("repo", os.Getenv("MBFS_PATH"), "MBFS_PATH to use")
...
func main() {
	...
	// precedence
	// 1. --repo flag
	// 2. MBFS_PATH environment variable
	// 3. default repo path
	var ipfsPath string
	if *repoPath != "" {
		ipfsPath = *repoPath
